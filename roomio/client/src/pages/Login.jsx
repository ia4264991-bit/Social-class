...
export default function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try { await login(form.email, form.password); navigate('/feed') }
    ...
    <div className="min-h-screen bg-dark-bg flex flex-col items-center justify-center p-4 safe-top">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-20 h-20 rounded-3xl mb-4 font-head font-black text-dark-bg text-3xl" style={{ background:'linear-gradient(135deg,#00c853,#CCA000)' }}>R</div>
          <h1 className="font-head font-black text-white text-3xl tracking-tight">Roomio <span className="text-brand-green">CS</span></h1>
